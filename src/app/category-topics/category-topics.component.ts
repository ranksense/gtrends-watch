...
export class CategoryTopicsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.seo.setPageTitle('Selected Trends - Google Trends Watcher');
    this.seo.setMetaDescription('Use the selected trends page to find the latest topics breaking out in Google Trends');
  }
